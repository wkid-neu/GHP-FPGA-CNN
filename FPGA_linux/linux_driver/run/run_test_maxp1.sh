...
do
    ...
    ../out/test_maxp1 --M ${M} --P ${P} --Q ${Q} --R ${R} --S ${S} --OC ${OC} --INC ${INC} --INH_ ${INH_} --INW_ ${INW_} --KH ${KH} --KW ${KW} --strideH ${strideH} --strideW ${strideW} --padL ${padL} --padR ${padR} --padU ${padU} --padD ${padD}
    echo "----------------------------"
done
