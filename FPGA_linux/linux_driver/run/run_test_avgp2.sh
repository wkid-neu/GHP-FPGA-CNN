...
do
    ...
    padU=${arr[$i*12+10]}
    padD=${arr[$i*12+11]}
    test_case_dir_path="/media/fpgagogogo/E1FDBB88D64498E9/program/Python/cnn_accel4/test_case_out/m${M}p${P}/avgp/${OC}_${INC}_${INH_}_${INW_}_${KH}_${KW}_${strideH}_${strideW}_${padL}_${padR}_${padU}_${padD}/case0/"
    echo "----------------------------"
    ...
    ../out/test_avgp2 --M ${M} --P ${P} --Q ${Q} --OC ${OC} --INC ${INC} --INH_ ${INH_} --INW_ ${INW_} --KH ${KH} --KW ${KW} --strideH ${strideH} --strideW ${strideW} --padL ${padL} --padR ${padR} --padU ${padU} --padD ${padD} --test_case_dir_path ${test_case_dir_path}
    echo "----------------------------"
done
