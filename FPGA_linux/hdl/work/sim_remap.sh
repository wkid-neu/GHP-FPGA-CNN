...
tcl_file_path="sim_remap.tcl"
conf_file_path="../tb/cfg_remap.yaml"
output_dir_path="../tb/sim_remap"
...
python3 /home/lvxing/SSD1_500G/FPGAcode/cyzcode/Python/cnn_accel6/test_case/remap.py --hw_params_fp __params.yaml --testcase_conf_fp $conf_file_path --output_dir_path $output_dir_path --rand_state 2023
