...
tcl_file_path="sim_add.tcl"
conf_file_path="../tb/cfg_add.yaml"
output_dir_path="../tb/sim_add"
...
python3 /home/lvxing/SSD1_500G/FPGAcode/cyzcode/Python/cnn_accel6/test_case/add.py --hw_params_fp __params.yaml --testcase_conf_fp $conf_file_path --output_dir_path $output_dir_path --rand_state 2023
