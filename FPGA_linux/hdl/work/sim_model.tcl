...
# Read source files
add_src "../src/"
add_files -fileset sim_1 "../tb/tb_model.sv"
...
set_property top tb_model [get_fileset sim_1]
# Replace this line to add macors
# set_property verilog_define [list OPT1=1, OPT2=2] [get_fileset sim_1]
# Run simulation
